...
public class LicenseController{
    ...
    // GetMapping for retrieving licenses by user
    ...
    public String getLicenciasByUser(Model model, @PathVariable Long id, HttpSession session){
        ...
        // Create a list of LicenciaYBeat objects
        ...
        model.addAttribute("usuario", (currentUser!= null && currentUser.getId()!=beats.findById(id).getProducerID() && !licencias.contains(currentUser)));
